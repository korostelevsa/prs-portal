              ...
              <div key={idx} className="rounded-xl border bg-white p-6 shadow-sm flex justify-between">
                <div className="min-w-0">
                  ...
                  <div className="mt-2 text-slate-500">
                    всего состояний: <span className="font-semibold text-slate-700">{cat.total}</span>
                  </div>
                  <div className="mt-1 text-slate-500">
                    ср. перцентиль: <span className="font-semibold text-slate-700">{cat.avgPercentile}</span>
                  </div>
                </div>
